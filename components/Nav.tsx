  ...
  { id: "home", type: "link", label: "Home", href: "/" },
  {
    ...
    columns: [
      { eyebrow: "Product", items: [
        ...
        { label: "Professional workspace", desc: "For clinicians managing cohorts.",       href: "/features/clinic-dashboard" },
      ...
      { eyebrow: "Markets", items: [
        ...
        { label: "Individual · direct",      desc: "The personal app, free to start.",       href: "/markets#consumer" },
      ]},
    ],
