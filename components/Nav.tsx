  ...
  { id: "home", type: "link", label: "Home", href: "/" },
  {
    ...
    columns: [
      { eyebrow: "Product", items: [
        ...
        { label: "Professional workspace", desc: "Individual monitoring and cohort insight, for any team.", href: "/features/clinic-dashboard" },
        { label: "Personal app",           desc: "BiotrackOS for iPhone & Android.",                       href: "/app" },
        { label: "Protocols",              desc: "Biomarker-driven recommendations.",                       href: "/features/protocols" },
        { label: "Integrations",           desc: "Connect every health data source.",                       href: "/integrations" },
        { label: "Marketplace",            desc: "Partners, add-ons & programmes.",                         href: "/marketplace" },
        { label: "API & SDK",              desc: "Wearable data APIs and SDKs for builders.",               href: "/platforms" },
      ]},
      { eyebrow: "Markets", items: [
        { label: "Clinics & longevity labs", desc: "Individual records, cohort dashboards, and protocols.", href: "/markets#longevity" },
        { label: "Sports teams & gyms",      desc: "Athletes, squads, and gym members — one record.",       href: "/markets#performance" },
        { label: "Insurance",                desc: "Consented streams, never surveys.",                     href: "/markets#insurer" },
        { label: "Corporate wellness",       desc: "Workforce health and wellbeing programmes, at scale.",   href: "/markets#wellness" },
        { label: "Research & pharma",        desc: "Real-world signal, audit-ready.",                       href: "/markets#research" },
        { label: "Public health & events",   desc: "City programmes, mass-event cohorts.",                  href: "/markets#public" },
        { label: "Individual · direct",      desc: "Your complete health record, in one app.",              href: "/markets#consumer" },
      ]},
    ],
